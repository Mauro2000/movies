...
<link rel="stylesheet" href="<?php echo e(asset('css/serie-details.css')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="img-background" style="background-image:url(<?php echo e(asset('movies/'.$serie->IMDB.'/'.$serie->cover[0]->image.'')); ?>);"></div>

    <div class="recipe-popcorn">
        <a data-toggle="modal" data-target="#exampleModal">
        <img src="" id="popcorn-svg" alt="" srcset="<?php echo e(asset('images/popcorn.svg')); ?>">
        </a>
    ...
    <section class="position-relative infos">
        ...
        <img class="poster" src="<?php echo e(asset('movies/'.$serie->IMDB.'/'.$serie->IMDB.'.jpg')); ?>"/>
        <h2 class=" title mb-3"><?php echo e($serie->name); ?></h2>

        <div class="d-flex mb-3" id="info-movie">
            <span class="mr-3"><i class="far fa-star"></i> IMDB: <?php echo e(str_replace(',','.',$serie->votes)); ?></span>
            <span class="time mb-3 mr-3">
                <i class="far fa-clock"></i>
                Duração: <?php echo e($serie->time); ?></span>
            <div class="year mr-3">
                <i class="fas fa-calendar-alt"></i>
                Ano: <?php echo e($serie->year); ?></div>
        </div>

        <p class="Description summary mb-3"> <?php echo e(\Illuminate\Support\Str::limit($serie->summary,119)); ?></p>


        <p><span>Diretor:</span><span><?php echo e($serie->director); ?></span></p>
            ...
            <div class="genres mb-3">
                ...
                <a class="mr-3" href="<?php echo e(route('listSeries',['category'=>Str::slug($item)])); ?>"data-toggle="tooltip" data-placement="top" title="<?php echo e($item); ?>"><?php echo e($item); ?></a>
            ...
            <div class="d-flex mt-3 m btns align-items-center r-mb-23 fadeInUp animated" data-animation-in="fadeInUp" data-delay-in="1.2" style="opacity: 1; animation-delay: 1.2s;">
                ...
                <?php if(Auth::user()->getFollows!='[]'): ?>
                    <?php $__currentLoopData = Auth::user()->getFollows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $follow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <?php if($follow->movie_id =="$serie->id"): ?>
                            <a href="javascript:void(0)" onclick="Follow('<?php echo e($serie->id); ?>')"  class="mr-2 btn-movies" id="follow_btn">
                ...
                <a href="javascript:void(0)" onclick="AddWishlist('<?php echo e($serie->id); ?>')"  class="mr-2 btn-movies" id="wishlist_btn" tabindex="0">
                ...
                <?php $__currentLoopData = $casts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div id="avatar" >
                            ...
                            <a><?php echo e(mb_convert_encoding($cast,'HTML-ENTITIES','utf-8')); ?></a>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="list">
        ...
        <div class="listing">
            ...
            <div class="row" style="justify-content: center;">
                <?php $__currentLoopData = $serie->seasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seasons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-4 p-5 temporadas" style="cursor:pointer;">
                        <span><a onclick="return getEpisodes('<?php echo e($seasons->id); ?>','<?php echo e($seasons->season); ?>','<?php echo e($serie->IMDB); ?>')">Temporada <?php echo e($seasons->season); ?></a></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div onclick="return getplayer('<?php echo e($serie->IMDB); ?>')" class="playerBtn">
                Player 1</div>
...
<?php echo $__env->make('frontend.modals.popcorn-recipe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
         ...
         function warezPlugin(season,episode){
           ...
           //  var season=$('#showserie').data('season');
            // var episode=$('#showserie').data('episode');
             var imdb="<?php echo e($serie->IMDB); ?>";
             var type="serie";
...
<script>
    function getEpisodes(id,season,imdbid){
        ...
        $.ajax({
        url: "<?php echo e(route('getEpisodes')); ?>",
        type:"POST",
        data:{
          seasonid: id,
        ...
        success:function(result){
                ...
                for (var i=0;i<=json[0]['Episodes'].length;i++){
                    if(json[0]['Episodes'][i]['image']== "default"){
                        var image="<?php echo e(asset('movies/'.$serie->IMDB.'/'.$serie->IMDB.'cover.jpg')); ?>";
                    }else{
...
<script>
 function Follow(idIMDB){
        ...
        $.ajax({
        url: "<?php echo e(route('addFollow')); ?>",
        type:"POST",
        dataType: 'JSON',
        data:{
            idIMDB: idIMDB,
...
<?php echo $__env->make('frontend.header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movies\resources\views/frontend/serie-details.blade.php ENDPATH**/ ?>