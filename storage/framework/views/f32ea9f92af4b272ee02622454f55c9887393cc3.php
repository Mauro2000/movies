...
<div class="modal fade bd-example-modal-lg" id="addmovie" tabindex="-1" role="dialog" aria-labelledby="formModal"
   ...
   <div class="modal-content">
       ...
       <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('adminAddMovie')); ?>" novalidate="">
           <?php echo csrf_field(); ?>
           <div class="row">
               <div class="col-12">
...
<div class="modal fade" id="addMovieServer" tabindex="-1" role="dialog" aria-labelledby="formModal"
   ...
   <div class="modal-content">
       ...
       <div class="modal-body">
       <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('adminAddCategs')); ?>" novalidate="">
           <?php echo csrf_field(); ?>
           <div class="row">
               <div class="col-12">
                <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\movies\resources\views/admin/modals/addMovie.blade.php ENDPATH**/ ?>