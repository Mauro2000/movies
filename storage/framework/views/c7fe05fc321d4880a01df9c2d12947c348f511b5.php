...
<div class="modal fade bd-example-modal-lg" id="addSerie" tabindex="-1" role="dialog" aria-labelledby="formModal"
   ...
   <div class="modal-content">
       ...
       <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('adminAddSerie')); ?>" novalidate="">
           <?php echo csrf_field(); ?>
           <div class="row">
               <div class="col-12">
...
<?php /**PATH C:\xampp\htdocs\movies\resources\views/admin/modals/series/addSerie.blade.php ENDPATH**/ ?>