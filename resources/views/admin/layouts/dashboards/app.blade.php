...
{{-- <div class="loader"></div> --}}
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown dropdown-list-toggle">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              <div class="dropdown-header">
                Notifications
                <div class="float-right">
                  <a href="{{route('Admin.notification.deleteAll')}}">Mark All As Read</a>
                </div>
              </div>
              <div class="dropdown-list-content dropdown-list-icons">
                @foreach ($user->unreadNotifications as $notification)
                <a href="{{route('Admin.notification.delete',[$notification->id])}}" class="dropdown-item dropdown-item-unread">
                <span class="dropdown-item-icon bg-primary text-white">
                  <i class="fas fa-code"></i>
                </span>
                <span class="dropdown-item-desc">{{$notification->data['message']}} <span class="time">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="/users/{{$user->avatarUrl}}"
                class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Olá, {{$user->name}}</div>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ activeMenu('products') }}">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="film"></i><span>Filmes</span></a>
              <ul class="dropdown-menu">
                <li class="{{ activeSubMenu('products') }}"><a class="nav-link" href="{{route('adminListMovies')}}">Ver Lista de Filmes</a></li>
                <li class="{{ activeSubMenu('categorias') }}"><a class="nav-link" href="{{route('adminListCategs')}}">Categorias de Filmes</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('adminListSeries')}}">Ver Lista de Series</a></li>
            ...
            <li class="dropdown">
              ...
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('adminListSliders')}}">Ver Sliders</a></li>

                  </ul>
                </li>

                <li class="menu-header"><a href="{{route('settings')}}">Settings</a></li>
 ...
 {{--  @include('Admin.modals',['Categ' => $Categs]); --}}
